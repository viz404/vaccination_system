                    ...
                    <main class="form-signin">
                        <form method="post">
                            ...
                            <div class="form-floating">
                                <input type="number" id="contact" name="contact" class="form-control" maxLength="10" placeholder="Contact" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" required>
                            ...
                            <button class="w-100 btn btn-lg btn-darkgreen" type="submit">Login</button>
                        </form>
