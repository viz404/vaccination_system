    ...
    <div class="customer-login">
      <main class="form-signin">
        <form method="post">
          ...
          <h1 class="h3 mb-3 fw-normal">Center login</h1>
          ...
          <button class="w-100 btn btn-lg btn-lightgreen" type="submit">Login</button>
        </form>
        <div class="row">
          <div class="col-12">
            <a href="centerSignup.php">
              <button class="w-100 btn btn-lg btn btn-darkgreen mt-2">Register</button>
            </a>
          </div>
          <!-- <div class="col-6 column2">
            <a href="vaccinatorSignup.php">
              <button class="w-100 btn btn-lg btn btn-info mt-2">Vaccinator</button>
            </a>
          </div> -->
        </div>
      </main>
